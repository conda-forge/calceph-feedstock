...
Development: https://gitlab.obspm.fr/imcce_calceph/calceph
...
It is possible to list all of the versions of `calceph` available on your platform:
...
```
pixi search calceph --channel conda-forge
```
